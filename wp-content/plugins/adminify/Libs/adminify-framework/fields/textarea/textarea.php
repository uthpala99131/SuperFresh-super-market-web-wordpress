  ...
  class ADMINIFY_Field_textarea extends ADMINIFY_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( ADMINIFY::$shortcode_instances ) ) ? ADMINIFY::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary adminify-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
